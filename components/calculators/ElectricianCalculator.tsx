...
export function ElectricianCalculator() {
  const [serviceType, setServiceType] = useState<ElectricianService['serviceType']>('repair');
  const [complexity, setComplexity] = useState<ElectricianService['complexity']>('moderate');
  const [isEmergency, setIsEmergency] = useState<boolean>(false);
  const [baseRate, setBaseRate] = useState<number>(0);
  const [serviceQuality, setServiceQuality] = useState<ElectricianService['serviceQuality']>('good');
  const [result, setResult] = useState<ElectricianService | null>(null);
  ...
  const handleCalculate = () => {
    ...
    const emergencyMultiplier = isEmergency ? 2.5 : 1;
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Select
            value={serviceType}
            onValueChange={(value: ElectricianService['serviceType']) => setServiceType(value)}
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            value={complexity}
            onValueChange={(value: ElectricianService['complexity']) => setComplexity(value)}
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: ElectricianService['serviceQuality']) => setServiceQuality(value)}
          >
            <SelectTrigger>
      ...
      {result && (
        <Card>
          <CardHeader>
            <CardTitle>Electrical Service Breakdown</CardTitle>
          </CardHeader>
